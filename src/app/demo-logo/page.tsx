    ...
    return (
        <div className={styles.container}>
            <header className={styles.header}>
                <h1>Sunday Logo Variants</h1>
                <p>Complete logo system for dark and light themes</p>
            </header>

            <section className={styles.section}>
                <h2>Logo Icon Only</h2>
                <div className={styles.variants}>
                    <div className={styles.card + ' ' + styles.dark}>
                        <div className={styles.logoWrapper}>
                            <Logo size={80} />
                        </div>
                        <p className={styles.label}>Dark Theme</p>
                    </div>
                    <div className={styles.card + ' ' + styles.light}>
                        <div className={styles.logoWrapper}>
                            <LogoLight size={80} />
                        </div>
                        <p className={styles.label}>Light Theme</p>
                    </div>
                </div>
            </section>

            <section className={styles.section}>
                <h2>Logo with Brand Name</h2>
                <div className={styles.variants}>
                    <div className={styles.card + ' ' + styles.dark}>
                        <div className={styles.logoWrapper}>
            ...
            <section className={styles.section}>
                ...
                <div className={styles.downloadGrid}>
                    <div className={styles.downloadCard}>
                        ...
                        <span>logo.svg</span>
                        <a href="/logo.svg" download className={styles.downloadBtn}>Download</a>
                    </div>
                    <div className={styles.downloadCard}>
                        <img src="/logo-light.svg" alt="Logo Light" width={60} height={60} />
                        <span>logo-light.svg</span>
                        <a href="/logo-light.svg" download className={styles.downloadBtn}>Download</a>
                    </div>
                    <div className={styles.downloadCard}>
                        <img src="/logo-with-text.svg" alt="Logo with Text" width={160} height={50} />
                        <span>logo-with-text.svg</span>
                        <a href="/logo-with-text.svg" download className={styles.downloadBtn}>Download</a>
                    </div>
                    <div className={styles.downloadCard}>
                        <img src="/logo-with-text-light.svg" alt="Logo with Text Light" width={160} height={50} />
                        <span>logo-with-text-light.svg</span>
                        <a href="/logo-with-text-light.svg" download className={styles.downloadBtn}>Download</a>
                    </div>
                </div>
            </section>
